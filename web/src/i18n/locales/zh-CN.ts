export default {
    ...
    config: {
        ...
        importedChannelApiKeyRequired: "导入链接缺少 API Key，未修改任何渠道",
        importedChannelBaseUrlInvalid: "导入链接中的 Base URL 无效，未修改任何渠道",
        codeExchange: {
            success: "授权配置已导入",
            missingParams: "启动地址缺少有效的 baseUrl 或 code，请重新打开",
            invalidBaseUrl: "启动地址中的 baseUrl 无效，请重新打开",
            timeout: "授权码兑换超时，请返回来源系统重新打开",
            requestFailed: "授权码兑换请求失败，请返回来源系统重新打开",
            invalidResponse: "授权码兑换响应无效，请返回来源系统重新打开",
            failed: "授权码兑换失败，请返回来源系统重新打开",
        },
