export default {
    ...
    config: {
        ...
        importedChannelApiKeyRequired: "The import link has no API key. No providers were changed.",
        importedChannelBaseUrlInvalid: "The import link has an invalid Base URL. No providers were changed.",
        codeExchange: {
            success: "Authorization settings imported",
            missingParams: "The launch URL is missing a valid baseUrl or code. Open it again.",
            invalidBaseUrl: "The baseUrl in the launch URL is invalid. Open it again.",
            timeout: "Authorization code exchange timed out. Return to the source system and open it again.",
            requestFailed: "Authorization code exchange failed. Return to the source system and open it again.",
            invalidResponse: "The authorization code exchange response is invalid. Return to the source system and open it again.",
            failed: "Authorization code exchange failed. Return to the source system and open it again.",
        },
